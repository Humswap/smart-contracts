...
namespace PitaTossTests
{
    ...
    public class PitaTossContractTests : IClassFixture<CheckpointFixture<PitaTossContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public PitaTossContractTests(CheckpointFixture<PitaTossContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("PitaTossTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<PitaTossContract>();

    ...
    public class Pita : SmartContract
    {
        ...
        */
        ...
        private static void SubMint(UInt160 forAddress)
        {
            ...
            token.Name = "Pita";
            token.Image = $"https://www.humswap.org/image/pita/{updatedSupply}";
            token.TokenURI = $"https://www.humswap.org/data/pita/{updatedSupply}";

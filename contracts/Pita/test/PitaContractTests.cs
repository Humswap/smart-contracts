...
namespace PitaTests
{
    ...
    public class PitaContractTests : IClassFixture<CheckpointFixture<PitaContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public PitaContractTests(CheckpointFixture<PitaContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("PitaTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<PitaContract>();

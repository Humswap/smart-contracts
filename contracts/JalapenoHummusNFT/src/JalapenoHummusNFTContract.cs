...
namespace JalapenoHummusNFT
{
    [DisplayName("Jalapeno Hummus NFT")]
    [ManifestExtra("Author", "Humswap")]
    [ManifestExtra("Email", "info@humswap.org")]
    [ManifestExtra("Description", "Jalapeno Hummus is the third NFT from Humswap")]
    [SupportedStandards("NEP-17")]
    [ContractPermission("*", "onNEP17Payment")]
    [ContractPermission("*", "transfer")]
    public class JalapenoHummusNFTContract : SmartContract
    {
        ...
        public static string tokenid = "0003";
        public static string series = "Originals";

        [Safe]
        public static string Symbol() => "JHUM";
        ...
        const string imageOfNFT = "https://www.humswap.org/jalapenohummus";

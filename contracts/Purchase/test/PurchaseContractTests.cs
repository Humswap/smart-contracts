...
namespace PurchaseTests
{
    ...
    public class PurchaseContractTests : IClassFixture<CheckpointFixture<PurchaseContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public PurchaseContractTests(CheckpointFixture<PurchaseContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("PurchaseTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<PurchaseContract>();

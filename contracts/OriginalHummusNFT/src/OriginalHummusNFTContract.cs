...
namespace OriginalHummusNFT
{
    ...
    [ManifestExtra("Description", "Original Hummus is the first NFT from Humswap")]
    ...
    public class OriginalHummusNFTContract : SmartContract
    {
        ...
        public static string tokenid = "0001";
        public static string series = "Originals";

        [Safe]
        public static string Symbol() => "OGHUM";
        ...
        const string imageOfNFT = "https://www.humswap.org/OGHummus";

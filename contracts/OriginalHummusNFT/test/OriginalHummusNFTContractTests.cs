...
namespace OriginalHummusNFTTests
{
    ...
    public class OriginalHummusNFTContractTests : IClassFixture<CheckpointFixture<OriginalHummusNFTContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public OriginalHummusNFTContractTests(CheckpointFixture<OriginalHummusNFTContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("OriginalHummusNFTTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<OriginalHummusNFTContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<OriginalHummusNFTContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<OriginalHummusNFTContract>();
            var contractStorage = storages.StorageMap("OriginalHummusNFTContract");
